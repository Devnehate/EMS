import { ArrowRightIcon, ShipIcon, UserIcon } from "lucide-react"
...
const LoginLanding = () => {
    ...
    const portalOptions = [
        ...
        },
        {
            ...
            Description: "View your profile, track attendance, request time off, and access payalips.",
            icon: UserIcon
        },
    ]
            ...
            <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
                ...
                <div className="w-full max-w-md animate-fade-in relative z-10">
                    ...
                    <div className="mb-10 text-center md:text-left">
                        <h2 className="text-3xl font-medium text-slate-900 tracking-tight mb-3">Welcome Page</h2>
